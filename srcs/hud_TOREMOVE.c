...
void	ft_write_left_panel_general_infos_hud(t_data *data, char *text, int offset_y)
{
	int		text_x = HUD_OFFSET_X;
	int		text_y = 20 + offset_y;
	mlx_string_put(data->mlx_ptr, data->window.win_ptr, text_x, text_y, ft_rgb_to_color(0, 255, 0), text);
...
void	ft_write_left_panel_specific_infos_hud(t_data *data, char *text, int offset_y)
{
