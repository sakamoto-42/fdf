...
/*   Updated: 2025/02/06 17:41:17 by juduchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_left_panel_2_display(t_data *data, t_panel_hud *left_panel_2)
{
	...
	left_panel_2->offset_y = (data->header_panel.texts_count + 1)
		* HUD_TEXT_HEIGHT;
	left_panel_2->color = ft_rgb_to_color(255, 0, 0);
}
...
void	ft_set_left_panel_2_texts(t_data *data, t_panel_hud *left_panel_2)
{
	...
	left_panel_2->texts[0].offset_x = data->left_panel_1.size_x
	...
	ft_set_panel_texts_offset_x(left_panel_2, data->left_panel_1.size_x
		+ HUD_TEXT_OFFSET_X, 1);
