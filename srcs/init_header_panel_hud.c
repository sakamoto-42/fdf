...
/*   Updated: 2025/02/08 16:33:49 by juduchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_header_panel_display(t_data *data, t_panel_hud *header_panel)
{
	...
	header_panel->color = ft_rgb_to_color(data, 0, 0, 255);
}
...
void	ft_set_header_panel_texts(t_data *data, t_panel_hud *header_panel)
{
	...
	header_panel->texts[0].color = ft_rgb_to_color(data, 255, 255, 255);
	header_panel->texts[1].text = "";
	header_panel->texts[1].offset_x = 0;
	header_panel->texts[1].color = ft_rgb_to_color(data, 255, 255, 255);
}
